...
package us.kpatrick;
/**
 * Our two classes are DIP compliant because none of the higher modules depend on the lower modules.
 * It is not rigid, it is flexible and expandable.  They can take in any type of array that implements StringExpressable
 */
...
public class Driver {
	...
	static ArrayList<StringExpressable> array = new ArrayList<>();
...
//		Writer writer = new GuiWriter();
		...
		array.add(new Dummy("Thing 1"));
		array.add(new Dummy("Thing 2"));

		Reader testReader = new ListReader();
		Writer testWriter = new ListWriter();
